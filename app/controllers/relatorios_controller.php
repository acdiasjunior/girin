            ...
            if ($fr !== false) {
                ...
                for ($i = 1; $i <= ceil($quant / $cache); $i++) {
                    ...
                    foreach ($domicilios as $domicilio) {
                        ...
                        $linha[] = $domicilio['Indice']['vlr_indicador_v1'];
                        $linha[] = $domicilio['Indice']['vlr_indicador_v2'];
                        $linha[] = number_format($domicilio['Indice']['vlr_componente_gestacao'], 2, ',', '.');
                        $linha[] = $domicilio['Indice']['vlr_indicador_v3'];
                        $linha[] = $domicilio['Indice']['vlr_indicador_v4'];
                        $linha[] = $domicilio['Indice']['vlr_indicador_v5'];
                        $linha[] = number_format($domicilio['Indice']['vlr_componente_crianca'], 2, ',', '.');
                        $linha[] = $domicilio['Indice']['vlr_indicador_v6'];
                        $linha[] = $domicilio['Indice']['vlr_indicador_v7'];
                        $linha[] = number_format($domicilio['Indice']['vlr_componente_idoso'], 2, ',', '.');
                        $linha[] = $domicilio['Indice']['vlr_indicador_v8'];
                        $linha[] = $domicilio['Indice']['vlr_indicador_v9'];
                        $linha[] = number_format($domicilio['Indice']['vlr_componente_depedencia'], 2, ',', '.');
                        $linha[] = number_format($domicilio['Indice']['vlr_dimensao_vulnerabilidade'], 2, ',', '.');
                        $linha[] = $domicilio['Indice']['vlr_indicador_c1'];
                        $linha[] = $domicilio['Indice']['vlr_indicador_c2'];
                        $linha[] = number_format($domicilio['Indice']['vlr_componente_analfabetismo'], 2, ',', '.');
                        $linha[] = $domicilio['Indice']['vlr_indicador_c3'];
                        $linha[] = $domicilio['Indice']['vlr_indicador_c4'];
                        $linha[] = $domicilio['Indice']['vlr_indicador_c5'];
                        $linha[] = number_format($domicilio['Indice']['vlr_componente_escolaridade'], 2, ',', '.');
                        $linha[] = number_format($domicilio['Indice']['vlr_dimensao_conhecimento'], 2, ',', '.');
                        $linha[] = $domicilio['Indice']['vlr_indicador_t1'];
                        $linha[] = number_format($domicilio['Indice']['vlr_componente_disponibilidade'], 2, ',', '.');
                        $linha[] = $domicilio['Indice']['vlr_indicador_t2'];
                        $linha[] = $domicilio['Indice']['vlr_indicador_t3'];
                        $linha[] = number_format($domicilio['Indice']['vlr_componente_qualidade'], 2, ',', '.');
                        $linha[] = $domicilio['Indice']['vlr_indicador_t4'];
                        $linha[] = $domicilio['Indice']['vlr_indicador_t5'];
                        $linha[] = number_format($domicilio['Indice']['vlr_componente_remuneracao'], 2, ',', '.');
                        $linha[] = number_format($domicilio['Indice']['vlr_dimensao_trabalho'], 2, ',', '.');
                        $linha[] = $domicilio['Indice']['vlr_indicador_r1'];
                        $linha[] = $domicilio['Indice']['vlr_indicador_r2'];
                        $linha[] = $domicilio['Indice']['vlr_indicador_r3'];
                        $linha[] = number_format($domicilio['Indice']['vlr_componente_extrema_pobreza'], 2, ',', '.');
                        $linha[] = $domicilio['Indice']['vlr_indicador_r4'];
                        $linha[] = $domicilio['Indice']['vlr_indicador_r5'];
                        $linha[] = number_format($domicilio['Indice']['vlr_componente_pobreza'], 2, ',', '.');
                        $linha[] = $domicilio['Indice']['vlr_indicador_r6'];
                        $linha[] = number_format($domicilio['Indice']['vlr_componente_capacidade_geracao'], 2, ',', '.');
                        $linha[] = number_format($domicilio['Indice']['vlr_dimensao_recurso'], 2, ',', '.');
                        $linha[] = $domicilio['Indice']['vlr_indicador_d1'];
                        $linha[] = $domicilio['Indice']['vlr_indicador_d2'];
                        $linha[] = number_format($domicilio['Indice']['vlr_componente_trabalho_precoce'], 2, ',', '.');
                        $linha[] = $domicilio['Indice']['vlr_indicador_d3'];
                        $linha[] = $domicilio['Indice']['vlr_indicador_d4'];
                        $linha[] = $domicilio['Indice']['vlr_indicador_d5'];
                        $linha[] = number_format($domicilio['Indice']['vlr_componente_acesso_escola'], 2, ',', '.');
                        $linha[] = $domicilio['Indice']['vlr_indicador_d6'];
                        $linha[] = $domicilio['Indice']['vlr_indicador_d7'];
                        $linha[] = $domicilio['Indice']['vlr_indicador_d8'];
                        $linha[] = number_format($domicilio['Indice']['vlr_componente_progresso_escolar'], 2, ',', '.');
                        $linha[] = number_format($domicilio['Indice']['vlr_dimensao_desenvolvimento'], 2, ',', '.');
                        $linha[] = $domicilio['Indice']['vlr_indicador_h1'];
                        $linha[] = $domicilio['Indice']['vlr_indicador_h2'];
                        $linha[] = number_format($domicilio['Indice']['vlr_componente_propriedade'], 2, ',', '.');
                        $linha[] = $domicilio['Indice']['vlr_indicador_h3'];
                        $linha[] = number_format($domicilio['Indice']['vlr_componente_deficit'], 2, ',', '.');
                        $linha[] = $domicilio['Indice']['vlr_indicador_h4'];
                        $linha[] = number_format($domicilio['Indice']['vlr_componente_abrigalidade'], 2, ',', '.');
                        $linha[] = $domicilio['Indice']['vlr_indicador_h5'];
                        $linha[] = number_format($domicilio['Indice']['vlr_componente_acesso_agua'], 2, ',', '.');
                        $linha[] = $domicilio['Indice']['vlr_indicador_h6'];
                        $linha[] = number_format($domicilio['Indice']['vlr_componente_acesso_escoamento'], 2, ',', '.');
                        $linha[] = $domicilio['Indice']['vlr_indicador_h7'];
                        $linha[] = number_format($domicilio['Indice']['vlr_componente_acesso_coleta_lixo'], 2, ',', '.');
                        $linha[] = $domicilio['Indice']['vlr_indicador_h8'];
                        $linha[] = number_format($domicilio['Indice']['vlr_componente_acesso_eletricidade'], 2, ',', '.');
                        $linha[] = number_format($domicilio['Indice']['vlr_dimensao_habitacao'], 2, ',', '.');
                        ...
                        $linha[] = $domicilio['Regiao']['desc_regiao'];
